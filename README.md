...
## Stack
Java 25 (LTS) + Spring Boot 3 + Maven, Angular 21 (LTS) + Angular Material, PostgreSQL 16 + PostGIS (coverage zones), CMI payments (mock mode), Docker Compose deployment. See `docs/` for the full foundation doc chain (PRD, system design, architecture, security, database, UX/UI, test strategy, DevOps, sprint backlog).
